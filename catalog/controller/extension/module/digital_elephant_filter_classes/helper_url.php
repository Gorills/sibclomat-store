<?php
class ControllerExtensionModuleDigitalElephantFilterClassesHelperUrl extends Controller
{
    ...
    public function isAjaxRequest() {
        return (!empty($this->request->get['ajax_digital_elephant_filter']));
    }
    ...
    public function getUrlData()
    {
        if ($this->storageUrlData == null) {
            ...
            $ocfilter = [];
            if (!empty($this->request->get['ocfilter'])) {
                $ocfilter = $this->request->get['ocfilter'];
            }
