<?php
Class ControllerExtensionModuleDigitalElephantFilterClassesPanel extends Controller
{
    ...
    public function __construct($registry)
    {
        ...
        $this->panelFilter = $this->load->controller('extension/module/digital_elephant_filter_classes/panel_ocfilter/prototype');
    }
    ...
    public function render($setting, $is_ajax_render = false)
    {
        ...
        return $this->load->view('extension/module/digital_elephant_filter', $data);
    }
    ...
    protected function getJSConfig($setting)
    {
        ...
        return [
            ...
            'selector' => [
                ...
                'mobileToggleButton' => $setting['DEF_settings']['selector_mobile_toggle_button'],
            ],
            'action' => [
                ...
                'ajaxRenderPagination' => $this->url->link('extension/module/digital_elephant_filter_classes/pagination/ajaxRender'),
                'ajaxRenderQuantityProducts' => $this->url->link('extension/module/digital_elephant_filter_classes/quantity_product/ajaxRender'),
                'getProduct' => $this->url->link('extension/module/digital_elephant_filter_classes/get_product'),
                'ajaxCheckToRenderShowMore' => $this->url->link('extension/module/digital_elephant_filter_classes/show_more/ajaxCheckToRender'),
                'ajaxRenderPanel' => $this->url->link('extension/module/digital_elephant_filter_classes/panel/ajaxRender'),
                'ajaxSetStateSection' => $this->url->link('extension/module/digital_elephant_filter_classes/panel/ajaxSetStateSection')
            ],
            'text' => [
                'productNotFound' => $this->language->get('text_no_results'),
            ...
            'isMobileVersion' => (isset($setting['DEF_settings']['is_mobile_version'])),
    ...
    protected function getFilterPrice($setting)
    {
        if (!$this->storageFilterPrice) {
            $price = $this->model_extension_module_digital_elephant_filter->getMinMaxPrice($this->urlData['category_id']);
